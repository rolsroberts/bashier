		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ikorui5appmodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ikorui5appmodule-display": {
								"semanticObject": "ikorui5appmodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ikor.ui5appmodule",
									"url": sap.ui.require.toUrl("ikor/ui5appmodule")
								}
							}
						}
					}
